...
// ============================================
export async function generateGameFromScan(imageBase64Data, studentAge = 10, studentMedium = "English", subject = "Mixed", weakTopics = [], favoriteGame = "quiz", preferredGamesList = []) {
