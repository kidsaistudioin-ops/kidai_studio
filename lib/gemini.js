  ...
  for (const currentModel of modelsList) {
    try {
      ...
      if (errMsg.includes("API_KEY_INVALID") || errMsg.includes("403")) {
        ...
        lastError = new Error("Gemini API Key me naye models ka access nahi hai. Kripya aistudio.google.com se NAYI key banakar .env.local me dalein!");
        break; // Saare models fail hone par final clear error dena
      }
