...
Return JSON: {"title":"...","questions":[{"q":"...","opts":["A","B","C","D"],"correct":0,"explain":"...","emoji":"..."}]}`,
  ...
  homework: (age, subject, weakTopics = [], favoriteGame = "quiz") =>
    ...
    RULE 2: VERY IMPORTANT! Generate 5 to 10 questions for the chosen game so the child has enough content to play.
    RULE 3: BILINGUAL SUPPORT (DUAL LANGUAGE). Har question aur option ko English ke sath-sath Hinglish (Hindi written in English alphabet) mein bhi translate karke do taaki weak bacche aaram se samajh sakein.
    RULE 4: IGNORE GIBBERISH. Agar scanned text mein ajeeb words (jaise 'apr ve', 'pm', '©') ya kachra (garbage characters) hain, toh unhe bilkul ignore karo. Sirf meaningful educational concepts se hi questions banao.
    RULE 5: IGNORE HANDWRITING. Photos mein agar pen ya pencil se kuch likha hua hai (baccho ki handwriting ya scribbles), toh usko bilkul ignore karo. Sirf aur sirf "Computer Printed Text" (jo book mein print hota hai) usi se sawal banao.
    Extract ALL questions from ALL provided images.
    Seed: ${Math.random().toString(36).slice(2, 6)}
    Return JSON: {"gameType":"one_of_the_50_types", "subject":"...", "gameTitle":"...", "questions":[{"original":"...","gameQ":"[English Question]","gameQ_hin":"[Hinglish Translation]","opts":["A","B","C","D"],"opts_hin":["Hinglish A","Hinglish B","Hinglish C","Hinglish D"],"correct":0,"explain":"...","emoji":"...","difficulty":"easy|medium|hard"}],"reward":"...","estimatedTime":"..."}`,
